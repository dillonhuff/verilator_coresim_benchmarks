...
void simulate_0( circuit_state* __restrict state ) {
  ...
  if (((state->self_clk_last) == 0) && ((state->self_clk) == 1)) {
    ...
    //cout << "Setting in_0_auto_reg_out to " << (int) (state->in_0_auto_reg) << endl;

    in_0_auto_reg_out = (state->in_0_auto_reg);
    sub_686_688_689_out = (((((lb_padded_2_stencil_update_stream$reg_0_2_out  -  lb_padded_2_stencil_update_stream$reg_2_2_out)  +  (lb_padded_2_stencil_update_stream$reg_0_1_out  *  0b0000000000000010))  -  (lb_padded_2_stencil_update_stream$reg_2_1_out  *  0b0000000000000010))  +  in_0_auto_reg_out)  -  lb_padded_2_stencil_update_stream$mem_2$mem_rdata);
    ...
    //(((int16_t) smax_762_763_764$max_mux_out)  >=  ((int16_t) sub_746_749_750_out))) ? smax_762_763_764$max_mux_out : sub_746_749_750_out)  <  lb_p3_cim_stencil_update_stream$reg_1_1_out))  &  MASK(0b00000000000000000000000000000001, (0b0000000001100100  <=  lb_p3_cim_stencil_update_stream$reg_1_1_out)))) ? 0b0000000000000000 : 0b0000000011111111);

    cout << smax_762_763_764$max_mux_out << endl;
    cout << sub_746_749_750_out << endl;
    cout << smax_762_763_764$max_mux_out << endl;
    cout << sub_746_749_750_out << endl;
    cout << lb_p3_cim_stencil_update_stream$reg_1_1_out << endl;
    cout << lb_p3_cim_stencil_update_stream$reg_1_1_out << endl;
